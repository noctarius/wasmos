...
- `lib/libc/src/` owns the shared userland libc helper implementations (`string`, `stdio`, `ctype`, `stdlib`) so example applications and WASM services/drivers can reuse common libc methods instead of open-coding them.
