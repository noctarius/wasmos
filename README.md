...
- Compositor title text now renders as full text runs through font-service measure+raster-into IPC (instead of per-character title glyph requests), aligning title text behavior with `libui` text rendering.
