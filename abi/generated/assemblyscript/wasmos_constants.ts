...
export const BLOCK_BACKEND_UNKNOWN: i32 = 0;
// ATA/IDE controller; unit is the drive index.
export const BLOCK_BACKEND_ATA: i32 = 1;
...
export const BLOCK_BACKEND_VIRTIO_BLK: i32 = 2;
...
export const BLOCK_DESCRIPTOR_VERSION: i32 = 1;
...
export const BLOCK_DESCRIPTOR_LABEL_MAX: i32 = 144;
...
export const BLOCK_DESCRIPTOR_ID_MAX: i32 = 64;
...
export const BLOCK_REQUEST_VERSION: i32 = 1;
...
export const BLOCK_DST_BLOCK_BUFFER: i32 = 0;
...
export const BLOCK_DST_XFER_BUFFER: i32 = 1;
...
export const PARTITION_SCHEME_NONE: i32 = 0;
// Legacy MBR at LBA 0; four slots, type bytes, no labels.
export const PARTITION_SCHEME_MBR: i32 = 1;
// GPT header at LBA 1; type GUIDs, PARTUUIDs and labels.
export const PARTITION_SCHEME_GPT: i32 = 2;
...
// empty one from here.
// No superblock probe matched, and no backend named a filesystem.
export const FS_TYPE_UNKNOWN: i32 = 0;
// FAT12/16/32; BPB with a 0x55AA boot signature.
export const FS_TYPE_FAT: i32 = 1;
...
export const BLOCK_DESCRIPTOR_FLAG_PRESENT: i32 = 0x1;
// A filesystem service is mounted on it.
export const BLOCK_DESCRIPTOR_FLAG_ACTIVE_SERVICE: i32 = 0x2;
...
export const VOLUME_DESCRIPTOR_VERSION: i32 = 1;
...
export const VOLUME_DESCRIPTOR_LABEL_MAX: i32 = 64;
...
export const VOLUME_DESCRIPTOR_UUID_MAX: i32 = 16;
...
export const VOLUME_DESCRIPTOR_ID_MAX: i32 = 64;
...
export const VOLUME_DESCRIPTOR_FLAG_PRESENT: i32 = 0x1;
// The format carries a label; `label` is it, possibly empty.
export const VOLUME_DESCRIPTOR_FLAG_HAS_LABEL: i32 = 0x2;
// The format carries a volume id; `uuid` is it.
export const VOLUME_DESCRIPTOR_FLAG_HAS_UUID: i32 = 0x4;
// This system booted from this volume, as reported by the bootloader.
export const VOLUME_DESCRIPTOR_FLAG_BOOT: i32 = 0x8;
// A filesystem service has mounted it; advisory, not enforced.
export const VOLUME_DESCRIPTOR_FLAG_CLAIMED: i32 = 0x10;
// The backing device refuses writes.
export const VOLUME_DESCRIPTOR_FLAG_READ_ONLY: i32 = 0x20;
