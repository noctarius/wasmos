...
typedef enum {
    ...
    HC_IRQ_ACK = 80,
    HC_IRQ_UNROUTE = 81,
    HC_SERIAL_REGISTER = 82,
    HC_INPUT_PUSH = 83,
    HC_INPUT_READ = 84,
    HC_FRAMEBUFFER_INFO = 85,
    HC_FRAMEBUFFER_MAP = 86,
    HC_FRAMEBUFFER_PIXEL = 87,
    HC_BOOT_CONFIG_SIZE = 88,
    HC_BOOT_CONFIG_COPY = 89,
    HC_INITFS_FIND_PATH = 90,
    HC_EARLY_LOG_SIZE = 91,
    HC_EARLY_LOG_COPY = 92,
    HC_ENV_GET = 93,
    HC_ENV_SET = 94,
    HC_ENV_UNSET = 95,
    HC_ENV_ABORT = 96,
    HC_REGION_ALLOC = 97,
    HC_IRQ_CONFIGURE = 98,
    HC_IPC_SELECT_WAIT_TIMEOUT = 99,
    HC_XFER_BUFFER_ACQUIRE = 100,
    HC_XFER_BUFFER_UNBORROW = 101,
    HC_BUFFER_ACQUIRE = 102,
    HC_BUFFER_UNBORROW = 103,
    HC_XFER_BUFFER_REBORROW = 104,
    HC_BUFFER_REBORROW = 105,
    HC_SPAWN_INFO_BUFFER = 106,
    HC_WASI_PROC_EXIT = 107,
    HC_WASI_RANDOM_GET = 108,
    HC_BLOCK_BUFFER_MAP = 109,
    HC_XFER_BUFFER_MAP = 110,
    HC_XFER_BUFFER_UNMAP = 111,
    HC_KLOG_REGISTER_RING = 112,
    HC_MSI_ALLOC = 113,
    HC_MSI_FREE = 114,
    HC_MMIO_WRITE32 = 115,
    HC_IO_REGION_IN8 = 116,
    HC_IO_REGION_IN16 = 117,
    HC_IO_REGION_IN32 = 118,
    HC_IO_REGION_OUT8 = 119,
    HC_IO_REGION_OUT16 = 120,
    HC_IO_REGION_OUT32 = 121,
    HC_COUNT = 122,
} warp_hostcall_id_t;
