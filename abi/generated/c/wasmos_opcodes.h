...
enum {
     ...
     */
    PROC_IPC_SUBSCRIBE_EXIT_REQ = 0x213,
...
enum {
     ...
     */
    WASMOS_IPC_SHUTDOWN_REQ = 0xFF02,
...
static inline const char* wasmos_opcode_name(uint32_t subsystem_id, uint32_t type) {
    ...
    case WASMOS_OPCODE_SUBSYS_PROC_MANAGER:
        ...
        case 0x213: return "PROC_IPC_SUBSCRIBE_EXIT_REQ";
        case 0x214: return "PROC_IPC_EXIT_EVENT";
    ...
    case WASMOS_OPCODE_SUBSYS_GFX:
        ...
        case 0x210: return "GFX_IPC_GET_SURFACE_SPEC";
        case 0x211: return "GFX_IPC_ATTACH_SURFACE";
        case 0x212: return "GFX_IPC_DETACH_SURFACE";
    ...
    case WASMOS_OPCODE_SUBSYS_SYSTEM:
        switch (type) {
