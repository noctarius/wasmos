...
const BLOCK_DESCRIPTOR_VERSION int32 = 1
...
const BLOCK_DESCRIPTOR_LABEL_MAX int32 = 144
...
const BLOCK_DESCRIPTOR_ID_MAX int32 = 64
...
const BLOCK_REQUEST_VERSION int32 = 1
...
const BLOCK_DST_BLOCK_BUFFER int32 = 0
...
const BLOCK_DST_XFER_BUFFER int32 = 1
...
const PARTITION_SCHEME_NONE int32 = 0
// Legacy MBR at LBA 0; four slots, type bytes, no labels.
const PARTITION_SCHEME_MBR int32 = 1
// GPT header at LBA 1; type GUIDs, PARTUUIDs and labels.
const PARTITION_SCHEME_GPT int32 = 2
...
const BLOCK_DESCRIPTOR_FLAG_PRESENT int32 = 0x1
// A filesystem service is mounted on it.
const BLOCK_DESCRIPTOR_FLAG_ACTIVE_SERVICE int32 = 0x2
// Writes are refused by the backend.
const BLOCK_DESCRIPTOR_FLAG_READ_ONLY int32 = 0x4
...
const VOLUME_DESCRIPTOR_VERSION int32 = 1
...
const VOLUME_DESCRIPTOR_LABEL_MAX int32 = 64
...
const VOLUME_DESCRIPTOR_UUID_MAX int32 = 16
...
const VOLUME_DESCRIPTOR_ID_MAX int32 = 64
...
const VOLUME_DESCRIPTOR_FLAG_PRESENT int32 = 0x1
// The format carries a label; `label` is it, possibly empty.
const VOLUME_DESCRIPTOR_FLAG_HAS_LABEL int32 = 0x2
// The format carries a volume id; `uuid` is it.
const VOLUME_DESCRIPTOR_FLAG_HAS_UUID int32 = 0x4
// This system booted from this volume, as reported by the bootloader.
const VOLUME_DESCRIPTOR_FLAG_BOOT int32 = 0x8
// A filesystem service has mounted it; advisory, not enforced.
const VOLUME_DESCRIPTOR_FLAG_CLAIMED int32 = 0x10
// The backing device refuses writes.
const VOLUME_DESCRIPTOR_FLAG_READ_ONLY int32 = 0x20
...
const SVC_CLASS_EVENT_ADD int32 = 1
// A provider unregistered, or its process died and was reaped.
const SVC_CLASS_EVENT_REMOVE int32 = 2
