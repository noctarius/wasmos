...
pub extern "wasmos" fn io_in8(a0: i32, a1: i32) callconv(.c) i32;
...
/// Returns 0 on success, otherwise a negative WASMOS_ERR_IO_* code naming
/// which check refused it. Requires the io.port capability for that port.
pub extern "wasmos" fn io_in16(a0: i32, a1: i32) callconv(.c) i32;
...
/// caller's linear memory.
pub extern "wasmos" fn thread_join(a0: i32, a1: i32) callconv(.c) i32;
