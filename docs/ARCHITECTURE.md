...
- Scope is intentionally narrow and explicit: common IPC wait/call patterns, name pack/unpack helpers, buffer borrow/release helpers, filesystem path-read helpers, libc-style string/ctype adapters, and small shared primitives such as SHA-256.
