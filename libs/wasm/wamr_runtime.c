...
extern volatile uint32_t wasmos_wamr_impdep_hits;
extern volatile void *wasmos_wamr_impdep_ip;
extern volatile void *wasmos_wamr_impdep_sp;
extern volatile void *wasmos_wamr_impdep_csp;
...
int wamr_call_function(wamr_instance_t *instance,
    ...
    wasmos_wamr_impdep_hits = 0;
    wasmos_wamr_impdep_ip = 0;
    wasmos_wamr_impdep_sp = 0;
    wasmos_wamr_impdep_csp = 0;
    ...
    serial_write("[wamr] impdep hits=");
    serial_write_hex64_local((uint64_t)wasmos_wamr_impdep_hits);
    serial_write("[wamr] impdep ip=");
    serial_write_hex64_local((uint64_t)(uintptr_t)wasmos_wamr_impdep_ip);
    serial_write("[wamr] impdep sp=");
    serial_write_hex64_local((uint64_t)(uintptr_t)wasmos_wamr_impdep_sp);
    serial_write("[wamr] impdep csp=");
    serial_write_hex64_local((uint64_t)(uintptr_t)wasmos_wamr_impdep_csp);
