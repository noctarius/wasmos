...
declare function plantOnWait(endpoint: i32, type: i32, requestId: i32, source: i32, a0: i32,
                             a1: i32, a2: i32, a3: i32): i32;
...
class ChainingHandler extends OnMessage {
  ...
  constructor(private loop: EventLoop, private sink: OnMessage) {
    super();
  }
