...
int main(void) {
    struct {
        ...
        {"W1 non-blocking polls do not arm a waiter",
         test_non_blocking_polls_do_not_arm_a_waiter},
        ...
        {"B4 blocking recv enforces ownership", test_blocking_recv_enforces_ownership_and_arguments},
        ...
        {"S7 select is signalled by a send", test_select_is_signalled_by_a_send_to_a_watched_endpoint},
